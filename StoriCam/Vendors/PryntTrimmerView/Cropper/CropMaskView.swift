...
class CropMaskView: UIView {
    ...
    private func setupSubviews() {
        ...
        frameLayer.strokeColor = ApplicationSettings.appWhiteColor.cgColor
        frameLayer.fillColor = ApplicationSettings.appClearColor.cgColor
        ...
        cropBoxView.backgroundColor = ApplicationSettings.appWhiteColor.withAlphaComponent(0.7)
