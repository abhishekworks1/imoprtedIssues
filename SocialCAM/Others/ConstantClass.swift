...
public struct Constant {
    ...
    struct Application {
        ...
        static let appIcon = (releaseType == .store) ? (R.image.quickCamSplashLogoOfficialLaunch() ?? UIImage()) : (R.image.quickCamSplashLogoOfficialLaunch() ?? UIImage())
    ...
    struct IAPProductIds {
        ...
        static let quickCamLiteAdvance = "app.quickcamlite.app.advance"
        static let quickCamLitePro = "app.quickcamlite.app.pro"
    }
