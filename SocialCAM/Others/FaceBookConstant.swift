...
public enum NeededFields: String {
    ...
    case updatedtime                   = "updated_time"                        // Updated time,datetime
    ...
    case devicesType                    = "devices"                             /* The list of devices the person is using. This will return only iOS and
                                                                                   Android devices */
    case favoriteathletes              = "favorite_athletes"                   // Athletes the person likes
    case favoriteteams                 = "favorite_teams"                      // Sports teams the person likes
    ...
    case inspirationalpeople           = "inspirational_people"                // list, The person's inspirational people
}

public struct FBError {
