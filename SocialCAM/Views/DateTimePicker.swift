...
//  ViralCam
//
//  Created by Viraj Patel on 30/03/20.
...
open class DateTimePicker {
    ...
    private static let sharedInstance = DateTimePicker()
    ...
    */
    ...
    private class func controller(title: String? = nil,
                          ...
                          dataArray:Array<String> = [],
                          selectedIndex: Int? = nil,
                          type: DateTimePickerType = .date) -> DateTimePickerController? {
        
        
        if let cc = UIWindow.currentController {
            if DateTimePicker.sharedInstance.isPresented == false {
                DateTimePicker.sharedInstance.isPresented = true
                
                let vc = DateTimePickerController(title: title, cancelText: cancelText, doneText: doneText, datePickerMode: datePickerMode, selectedDate: selectedDate, minDate: minDate, maxDate: maxDate, dataArray: dataArray, selectedIndex: selectedIndex, type: type)
                ...
                vc.onWillDismiss = {
                    DateTimePicker.sharedInstance.isPresented = false
                }
...
class DateTimePickerController: UIViewController {
    ...
    var pickerType: DateTimePickerType = .date
...
extension DateTimePickerController: UIPickerViewDataSource, UIPickerViewDelegate {
