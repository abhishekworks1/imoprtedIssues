...
public class VSSlider: UIControl {
    ...
    fileprivate func updateSlider() {
        let layoutDirection: UIUserInterfaceLayoutDirection = UIApplication.shared.userInterfaceLayoutDirection
    ...
    private func updateTrackImage() {
        ...
        let maxTrackColor = maximumTrackTintColor ?? ApplicationSettings.appLightGrayColor
