...
public class ThumbSelectorView: AVAssetTimeSelector {
    ...
    public var thumbBorderColor: UIColor = ApplicationSettings.appWhiteColor {
        didSet {
            thumbView.layer.borderColor = thumbBorderColor.cgColor
        }
    }

    public let thumbView = UIImageView()
    ...
    private func setupDimmingView() {
        ...
        dimmingView.backgroundColor = ApplicationSettings.appWhiteColor.withAlphaComponent(0.7)
    ...
    @objc func handleTapGesture(_ gestureRecognizer: UITapGestureRecognizer) {
        ...
        case .recognized:
            let translation = gestureRecognizer.location(in: superView)
    ...
    private func generateThumbnailImage(for time: CMTime) {
        ...
        generator?.generateCGImagesAsynchronously(forTimes: [time.value as NSValue],
