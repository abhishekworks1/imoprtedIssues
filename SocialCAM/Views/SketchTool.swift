...
class PenTool: UIBezierPath, SketchTool {
    ...
    override init() {
        ...
        lineColor = ApplicationSettings.appBlackColor
        lineAlpha = 0
    ...
    func draw() {
        let context: CGContext = UIGraphicsGetCurrentContext()!
            ...
            case .neon:
                ...
                context.setLineCap(.round)
                context.setLineWidth(lineWidth)
                context.setStrokeColor(ApplicationSettings.appWhiteColor.cgColor)
...
class ArrowTool: SketchTool {
    ...
    func draw() {
        ...
        var point1 = pointWithAngle(angle: CGFloat(angle + Float(6.0 * .pi / 8.0)),
                                    distance: capHeight)
        var point2 = pointWithAngle(angle: CGFloat(angle - Float(6.0 * .pi / 8.0)),
                                    distance: capHeight)
