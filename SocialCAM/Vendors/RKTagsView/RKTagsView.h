...
@property (nonatomic, strong) NSCharacterSet* deliminater;
@property (nonatomic) bool isHasTag;
@property (nonatomic) CGPoint startPoint;
@property (nonatomic) NSInteger dragButtonIndex;
@property (nonatomic) NSInteger lastSelectedIndex;
@property(nonatomic) bool isMerge;
// defailt is [NSCharacterSet whitespaceCharacterSet]
