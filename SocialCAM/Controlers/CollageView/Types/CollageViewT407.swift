...
class CollageViewT407: CollageView {
    ...
    private func initCells() {
        ...
        let lc03 = NSLayoutConstraint(item: cell01, attribute: .right, relatedBy: .equal, toItem: self, attribute: .right, multiplier: 1/2, constant: 0)
        ...
        let lc011 = NSLayoutConstraint(item: cell04, attribute: .left, relatedBy: .equal, toItem: cell01, attribute: .right, multiplier: 1, constant: 0)
        ...
        self.paddingLeftTopContraints += [lc06, lc10, lc011]
